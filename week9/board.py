...
class Board:
    ...
    def __init__(self):
        ...
        self.side = 7
        self.target = (3, 7)
        self.board = [[VOID if i == self.side else UNDER_SCORE for i in range(self.side + ONE)] for j in range(self.side)]
        self.board[3][7] = EXIT
    ...
    def cell_list(self):
        ...
        return [(i, j) for i in range(self.side) for j in range(self.side)] + [self.target]
